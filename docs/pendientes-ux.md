...
Última actualización: **2026-09-04** (el rectángulo de recorte ya dibujado muestra `cursor-move` — se podía arrastrar para reposicionarlo, pero no era obvio).
