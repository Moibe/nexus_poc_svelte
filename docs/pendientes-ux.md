...
Última actualización: **2026-09-03** ("Historial de versiones" del menú `⋮` ahora abre el modal real; retirado el link "Listar versiones anteriores").
