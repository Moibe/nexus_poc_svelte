...
| La **X del header sube un nivel** en vez de cerrar siempre | Wizard del Módulo de configuración | Cambio pedido: desde el wizard regresa a la Biblioteca; desde la Biblioteca sí cierra. Antes sacaba hasta el Home — dos niveles de golpe. Escape y el clic fuera siguen cerrando del todo, que es la convención de un modal, y no pierden nada. |
